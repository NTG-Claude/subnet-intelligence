...
def _driver_phrase(name: str, *, negative: bool = False, uncertainty: bool = False) -> str:
    mapping = {
        ...
        "net_emission_pressure": "new token supply is still creating meaningful pressure",
        "token_sink_strength": "the subnet still lacks strong token sinks",
        "emission_dependency_ratio": "the setup still leans too heavily on incentives",
        "value_capture_alignment": "usage is not yet translating cleanly into token value capture",
